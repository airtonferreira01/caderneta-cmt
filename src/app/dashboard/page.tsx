  ...
  return (
    <div className="min-h-screen bg-green-600 dark:bg-gray-900 flex flex-col">
      ...
      <main className="flex-grow container mx-auto p-6">
        <div className="bg-white dark:bg-gray-100 rounded-lg shadow-xl overflow-hidden">
          {/* User Profile Header */}
          <div className="bg-green-800 dark:bg-green-700 p-6 text-white">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-green-50 dark:bg-white p-4 rounded-lg shadow">
                ...
                <div className="mt-4">
                  <Link 
                    href="/perfil/editar" 
                    className="inline-block bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md transition duration-300 dark:bg-green-600 dark:hover:bg-green-700"
                  >
                    Editar Perfil
                  </Link>
                </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <Link 
                  href="/organograma" 
                  className="bg-green-600 hover:bg-green-700 text-white p-4 rounded-lg flex flex-col items-center justify-center text-center transition duration-300 dark:bg-green-600 dark:hover:bg-green-700"
                >
      ...
      {/* Footer */}
      <footer className="bg-green-800 dark:bg-green-700 text-white p-4">
